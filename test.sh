...
scalac -Xprint:wrapper -Xplugin:scala-trace-plugin/target/scala-2.11/scala-trace-plugin_2.11-1.0.0.jar -P:scalatrace:12345 -cp scala-trace-runtime/target/scala-2.11/scala-trace-runtime_2.11-1.0.0.jar ${TEST_SOURCES_PATH}Compiler.scala ${TEST_SOURCES_PATH}SubComponent.scala
