...
class ICodeDataFlowGraph  {
    ...
    ICodeDataFlowGraph(String[] products) {
    ...
    private ICodeDataFlowGraphNode noPosition = new ICodeDataFlowGraphNode("NoPosition");
    private Stack<String> traceStack = new Stack();
    private Stack<ICodeDataFlowGraphNode> nodeStack = new Stack();
    ...
    private ICodeDataFlowGraphNode thisLineNode, dependOnLine, thisWrittenBy = null;
    private Stack<ICodeDataFlowGraphNode> thisStack = new Stack();
    ...
    public void log(String line, String op) {
        ...
        if (!lineMapToNode.containsKey(line)) {
            increase();
            ICodeDataFlowGraphNode newNode = new ICodeDataFlowGraphNode(line);
